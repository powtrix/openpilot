...
| [Lead response](cruise-gap.md#lead-response) | `LeadAccelResponse` | MPC response to a lead starting or accelerating at every following-distance level |
