...
const FALLBACK_STRINGS = {
  ...
  compiled_detail: "The Happy Birthday eGPU model is compiled and will be selected automatically.",
  ...
  restart_confirm: "Park the car and turn ignition on. Restart now to compile the Happy Birthday eGPU model?",
